...
hoverTests = testGroup "Hover tests"
  [ testHover "mini.l4 hover LegalPractitioner"         "mini.l4" (Position 20 10) (mkRange 13 0 13 17) "TokenSym \"LawRelatedService\""
  , testHover "mini.l4 hover the string 'lexicon'" "mini.l4" (Position 2 4)  (mkRange 2 0 2 7)    "This is a lexicon"
  , testHover "mini.l4 hover the string 'Business -> \"business_1_N\"'" "mini.l4" (Position 3 4)  (mkRange 3 0 3 8)    "This block maps variable Business to WordNet definion \"business_1_N\""
  ]
