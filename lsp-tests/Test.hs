...
hoverTests = testGroup "Hover tests"
  ...
  , expectFail                                $ testHover "Hover over nothing"                                        "mini.l4" (Position 1 0)   (mkRange 4 1 4 8)    "This block maps variable Business to WordNet definion \"business_1_N\""
  ]
...
typeCheckerTests = testGroup "Type Error tests"
  ...
  , testGroup "VarDeclsError"
      [
        testTypeErrs "undeclVar.l4        undefined variable MustNotAcceptApp"      "VarDeclsError/undeclVar.l4"          (mkRange 64 5 64 21) 6 "Variable MustNotAcceptApp at (65,6) .. (65,22) is undefined"
