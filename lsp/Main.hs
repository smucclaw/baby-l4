...
lookupToken pos (TextDocumentIdentifier uri) = do
  ...
  case allTokens of
    ...
    Right tokens -> do
      ...
      publishDiagnostics 100 nuri Nothing (Map.singleton(Just "lexer")(Data.SortedList.toSortedList [])) --"lexer" in this case is the DiagnosticSource which is of type Text
