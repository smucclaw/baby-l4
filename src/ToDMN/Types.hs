...
xpDefinitions = HXT.xpElem "definitions" $
                HXT.xpWrap ( uncurry13 Definitions
                       , \d -> ( sXmlns d
                               , sXmlnsDmndi d
                               , sXmlnsDc d
                               , sXmlnsModeler d
                ...
                HXT.xp13Tuple ( HXT.xpAttr "xmlns" HXT.xpText )
                          ...
                          ( HXT.xpAttrNS "http://camunda.org/schema/1.0/dmn" "modeler" "executionPlatform" HXT.xpText )
                          ( HXT.xpAttrNS "http://camunda.org/schema/1.0/dmn" "modeler" "executionPlatformVersion" HXT.xpText )
...
instance HXT.XmlPickler ToDMN.Types.Schema where
  xpickle = xpSchema

xpSchema :: HXT.PU ToDMN.Types.Schema
